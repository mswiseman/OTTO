...
If you have little experience with wiring with electronics, then it is strongly recommended to read up on the proper precautions that need to be taken [here](https://electrical-engineering-portal.com/21-safety-rules-for-working-with-electrical-equipment). Along a similar vein, if you have never soldered, then a breadboard can be used to wire the whole project. Breadboard connections are less durable than a solder joint, but jumper cables allow you to avoid soldering. A basic overview of supplies needed for breadboard prototyping and builds can be found (here)[]. You can find a run down on breadboard wiring [here](https://www.youtube.com/watch?v=6WReFkfrUIk), though I suggest becoming more familar with breadboard wiring and arduino processors before committing to build Otto. 
